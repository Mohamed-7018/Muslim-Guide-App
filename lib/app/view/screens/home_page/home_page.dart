...
import 'package:muslim_dialy_guide/app/view/common_widget.dart/backdrop/backdrop.dart';
...
class MUslimGuideAppHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BackDropMenu(
      settingPage: Container(color: GlobalAppColors.appBlue),
      homePage: Scaffold(
        body: Stack(
          children: [
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Row(
                              children: [
                                ...
                                GestureDetector(
                                  child: HomeContainer(
                                      image: GlobalAppImages
                                          .translatedQuraanSectionLogo,
                                      color: GlobalAppColors.appBlue,
                                ...
                                GestureDetector(
                                  child: HomeContainer(
                                      image: GlobalAppImages
                                          .mutashabihatSectionLogo,
                                      color: GlobalAppColors.appBlue,
                                      title: GlobalAppStrings
                                          .mutashabihatElQuraan),
                                  // onTap: () => Navigator.pushNamed(
                                ...
                                GestureDetector(
                                  ...
                                  onTap: () => Navigator.pushNamed(
                                      context, AzkarMainScreen.routeName),
                                ),
                                /*-----------------------------------------------------------------------------------------------*/
                                /*-------------------------------- Sebha App Container  -----------------------------------*/
                                /*-----------------------------------------------------------------------------------------------*/
